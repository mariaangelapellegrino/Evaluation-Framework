...
setup(
  ...
  version = '01.2',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/mariaangelapellegrino/Evaluation-Framework/archive/v_01.2.tar.gz',    # I explain this later on
