...
setup(
  ...
  version = '01.5',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/mariaangelapellegrino/Evaluation-Framework/archive/v_01.5.tar.gz',    # I explain this later on
